...
using DesignPatterns.StartUp;

public class Program
{
    private const string ExitCode = "q";
    private static readonly Dictionary<int, IExecutor> Executors = DesignPatternExecutorRegistry.Instance.GetAll();
    ...
    private static void ShowAvailableMenuOptions()
    {
        ...
        {
            Console.WriteLine($"{executor.Key}. {executor.Value.Description}");
        }
